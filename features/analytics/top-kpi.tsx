...
export function TopKpi() {
  ...
  return (
    <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      <p className="md:col-span-2 xl:col-span-4 text-[11px] text-stone-400">※ 売上・客単価・新規/リピートは会計（予約詳細→会計）確定分の当月集計。月間目標・達成度は月間シフトグリッドの日次目標の当月合計を参照（未入力なら「未設定」）。新規/リピート=来店客の過去の会計済来店有無で判定（電話番号優先）。</p>
    </section>
  );
}
